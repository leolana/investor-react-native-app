...
export const FormSuitabilityFour = (props) => {
	...
	const getInformacoes = async () => {
		let resp = await Request.GET({
			url:
				'https://hub-test.iouu.com.br/iouu/suitability/5eb01d7c6a6d3b0010855eb5',
		});
...
Esperamos que este seja o começo de uma parceria de muito sucesso entre você e a IOUU.`);
	...
	return (
		<SafeAreaView>
			<ScrollView>
				<Title>Seu perfil de investimento é: <Bold>{tipoPerfil}</Bold> </Title>
                <Faixa/>
				<Name>Parabéns, <Bold>{nome}</Bold>. </Name>
				<Info>{texto}</Info>
				<Gratters>
