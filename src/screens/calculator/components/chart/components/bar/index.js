...
export const Bar = props => {
    ...
    const baseAnimation = (target, toValue, duration) => Animated.timing(target, {
        toValue,
        duration,
    ...
    return (
        <BarContainer
            style={{
                ...
                transform: [
                    { translateY: translate.y.interpolate({  inputRange: [0, hp(19)], outputRange:[hp(19), 0], extrapolate: 'clamp' }) },
