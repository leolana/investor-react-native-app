...
import { IconEnd, IconStart, IconClock, IconInvestor } from '../../../../assets/icons';
  ...
  return (
    <>
      <Card>
        ...
        <ItemInfo center={true}>
          * A taxa de juros acima é igual ao seu Retorno Bruto (Retorno antes do desconto de IR e custos de TED)
        </ItemInfo>
