...
export const UrlTabelaValoresInvestidores = (solicitacaoId, reservaId) =>
  `${BASE_URL_GO}/api/v1/tabela/price/alongamento/${solicitacaoId}/${reservaId}`;
...
export const UrlSolicitacaoReservaInvCancelar = (solicitacaoId) =>
  `${BASE_URL_NODE}api/v1/reserva-investimentos-CANCEL/${solicitacaoId}`;
