        ...
        <TouchableWithoutFeedback onPress={ () => navigation.navigate('HistoricProfile', { data } ) } >
            <Container>
                ...
                <Body>
                    ...
                    <ItemTitle>ID: <ItemText>#{formatCode(data.SolicitacaoId.IdOportunidade)}</ItemText></ItemTitle>
                    <ItemTitle>CNPJ: <ItemText>{formatCNPJ(data.SolicitacaoId.Documento)}</ItemText></ItemTitle>
                    <ItemTitle>Valor investido: <ItemText>{formatMoney(data.Valor)}</ItemText></ItemTitle>
                    <ItemTitle>Prazo: <ItemText>{data.SolicitacaoId.Prazo} meses</ItemText></ItemTitle>
