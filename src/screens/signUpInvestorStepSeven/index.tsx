...
import { SafeAreaView, Button, ButtonText, TextInput, ScrollView, ContainerLine } from './styles';
...
export const SignUpInvestorStepSevenComponent = (props) => {
  ...
  return (
    <SafeAreaView>
      <ScrollView>
        <TextInput title={'Agência'} onChangeText={(value) => setBankAgency(value)} />

        <TextInput title={'Conta'} onChangeText={(value) => setBankAccount(value)} />
