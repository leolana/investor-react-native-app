...
import { Alert, TouchableOpacity, Text, Modal, ImageBackground, View, Image } from 'react-native';
    ...
    <>
      <Modal animationType="slide" transparent={false} visible={isVisible}>
        <RNCamera
          ...
          captureAudio={false}
        >
          <Icon name="camera-iris" size={80} onPress={onTakePicture} style={Styles.buttonTakePicture} />
          <Icon name="close" size={50} onPress={onCloseCamera} style={Styles.buttonCloseCamera} />
        </RNCamera>
      </Modal>
