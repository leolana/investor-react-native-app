...
import { BackgroundGradiant, Container, Item, ItemText, ItemTitle, Circle, CircleText } from './styles';
...
export const CardInput = (props) => {
  ...
  return (
    <BackgroundGradiant colors={[greenishBlue, tealish]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
      <Container>
        <Item>
