...
export const SignUpSuccess = props => {
    ...
    return (
        <SafeAreaView>
            ...
            <Title>
                O 1º passo para você fazer parte da IOUU foi concluído com sucesso!
            </Title>

            <Text>
                O próximo passo é completar o <Text bold={true} >cadastro de investidor</Text>, 
                preencher o formulário de suitability e aguardar o processo de análise e aprovação para 
