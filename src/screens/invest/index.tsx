...
import { SafeAreaView, ScrollView, Item, Title, Score, Subtitle, TextCNPJ } from './styles';

import { CircleWithChild } from '../../components';

import { InnitialStep, ConfirmationStep, PaymentStep } from './components';

import { formatCode, formatLoanType, convertScoreByColor, formatCNPJ } from '../../utils';

import { Request, UrlCarteiraSaldo } from '../../services';
    ...
    <SafeAreaView>
      <ScrollView>
        <Item>
          ...
          <CircleWithChild background={convertScoreByColor(data.Score)} size={18} />
        ...
        <Animated.View>{handleStep()}</Animated.View>
      </ScrollView>
    </SafeAreaView>
  );
};
