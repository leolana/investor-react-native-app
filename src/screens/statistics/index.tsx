...
import { Title, ScrollView, SafeAreaView, Card, ItemTitle, ItemText, Item } from './styles';

import { LinkList } from '../../components';

import { CardTotalInvestiments } from './components';

import { Request, UrlEstatisticasPegar } from '../../services';
...
export const PageStatistics = (props) => {
  ...
  return <SafeAreaView>{statistics != null ? renderPage() : null}</SafeAreaView>;
};
